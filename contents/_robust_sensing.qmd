...
## Robust Localization over Power Lines
...
2. Too few utility poles or immediate fences.  
   There are no trees or other geometries.
3. GPS provides absolute position.  
...
## Electric and Magnetic Field around Three-Phase Power Lines {auto-animate=true visibility="hidden"}
...
## Gradient of the Electric Field around Three-Phase Power Lines {auto-animate=true visibility="hidden"}
...
$$
Further, $\lVert \nabla_{\mathbf{q}}V(\mathbf{q}) \rVert = O\left(1/\bar{E}\right)$
...
## Robust Localization with GTSAM: Sensor Fusion

### Fuse $\nabla_{\mathbf{q}}\bar{E}(\mathbf{q})$, IMU, GPS, Camera Measurements {auto-animate=true}
...
![](./contents/assets/nodes_gtsam_2.svg){.absolute top=254 left=50 width="1400" height="250"}

:::

:::{.fragment .fade-in-then-out fragment-index=3 }

![](./contents/assets/nodes_gtsam_3.svg){.absolute top=310 left=50 width="1400" height="350"}
...
![](./contents/assets/nodes_gtsam_1.svg){.absolute top=310 left=50 width="1500" height="390"}
...
{{< video ./contents/assets/translate_trimmed.mp4 width=900 autoplay="true" >}}
:::

::: {.fragment .fade-in-then-out fragment-index=1}
![](./contents/assets/bearing_range_exp_arrangement.svg){width=900 fig-align="center"}
:::

::: {.fragment .fade-in-then-out fragment-index=2}
![](./contents/assets/estimated_true_line_phis_cal.svg){width="100%"}
:::

::: {.fragment .fade-in fragment-index=3}
![](./contents/assets/relative_position.svg){width="100%"}
:::
