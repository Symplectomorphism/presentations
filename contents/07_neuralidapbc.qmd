...
## <span style="font-variant:small-caps;">IdaPbc</span> Background {auto-animate="true" visibility="uncounted"}
<!-- ###################################################################### -->
...
## <span style="font-variant:small-caps;">IdaPbc</span> via Optimization {transition=slide-out visibility="uncounted"}
<!-- ###################################################################### -->
...
![](contents/assets/nn-pbc-struct-frame-05.png){fig-align="center"}


## <span style="font-variant:small-caps;">NeuralIdaPbc</span> Problem Statement  {transition="fade-in zoom-out" visibility="uncounted"}
...
::: {.fragment .fade-up fragment-index=0}
::: {.callout style="font-size: 0.85em;"}
...
## <span style="font-variant:small-caps;">SoS</span> Decomposition {visibility="uncounted"}
<!-- ###################################################################### -->
...
## <span style="font-variant:small-caps;">NeuralIdaPbc</span> Experiments {visibility="uncounted"}
<!-- ###################################################################### -->
...
## {background-video="contents/assets/iwp-firefox.mp4" background-size="contain" background-video-loop="true" background-video-muted="true" visibility="uncounted"}
<!-- ###################################################################### -->


## Simulated IWP experiments {visibility="uncounted"}
<!-- ###################################################################### -->

:::: {.r-stack}
![](contents/assets/idapbc-iwp-evolution.png){.fragment .fade-out fragment-index=0}

![](contents/assets/idapbc-contours.png){.fragment .fade-in-then-out fragment-index=0}

<!-- ![](contents/assets/compare_uru.png){.fragment .fade-in fragment-index=1} -->
...
:---:|:---:|:---:
![](contents/assets/compare_uRu_neuralpbc.svg) | ![](contents/assets/compare_uRu_neuralidapbc.svg){width=90%} | ![](contents/assets/compare_uRu_idapbc.svg){width=93%}
:::

::::


## Deterministic vs. Bayesian Training {.smaller visibility="uncounted"}
<!-- ###################################################################### -->
...
![](contents/assets/iwp.svg){width=50%}

![](contents/assets/bandplot.svg){width=90%}
...
## {background-video="contents/assets/iwp-cut-firefox.mp4" background-size="contain" background-video-loop="true" background-video-muted="true" visibility="uncounted"}
<!-- ###################################################################### -->
...
::: {.incremental .fragment data-fragment-index=0}
...
## Ball-beam experiments {visibility="uncounted"}
<!-- ###################################################################### -->

::: {.r-stack}
![](contents/assets/ball-beam.svg){.fragment .fade-out fragment-index=0}

::: {.fragment .fade-in fragment-index=0}
::: {layout="[100,85]" layout-valign="center"}
![](contents/assets/ball_beam-Vd-contour.svg)

![](contents/assets/ball_beam-evolution.svg)
:::
:::
:::