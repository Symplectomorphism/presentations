...
\hypersetup{
    ...
    pdftitle={Robust Passivity-Based Control of Underactuated Systems via Neural Approximators and Bayesian Inference},    % title
    pdfauthor={Nardos Ayele Ashenafi, Wankun Sirichotiyakul, Aykut C. Satici},     % author
